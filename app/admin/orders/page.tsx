...
const PaginationControls = ({ page, totalCount, perPage, onChange }: PaginationProps) => {
...
export default function AdminOrdersPage() {
        ...
        const orderTotalPages = Math.max(1, Math.ceil(filtered.length / ORDERS_PER_PAGE));
        const menuTotalPages = Math.max(1, Math.ceil(menuTotals.length / MENUS_PER_PAGE));
                ...
                <div className='space-y-6'>
                        ...
                        <Card className='text-sm'>
                                <div className='flex items-center justify-between border-b border-gray-100 px-4 py-3'>
                                        <h3 className='text-base font-semibold text-gray-900'>메뉴별 총 수량</h3>
                                        <span className='text-xs text-gray-500'>집계 기준: 필터링된 주문</span>
                                </div>
                                <div className='space-y-4 p-4'>
                                        ...
                                        <PaginationControls
                                                ...
                                                totalCount={menuTotals.length}
                                                perPage={MENUS_PER_PAGE}
                        ...
                        <Card className='text-sm'>
                                <div className='flex items-center justify-between border-b border-gray-100 px-4 py-3'>
                                        <h3 className='text-base font-semibold text-gray-900'>주문 목록</h3>
